function d3PieChart(dataset, datasetBarChart){
    ...
    height = 370 - margin.top - margin.bottom, //verticle space beteen graph and text
    outerRadius = Math.min(width, height) / 2, //scale outer
    innerRadius = outerRadius * .5, //scale inner
